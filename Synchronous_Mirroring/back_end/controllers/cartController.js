...
const { mirrorOperationToPostgres } = require('../mirrorOperations'); // Import the mirroring function
...
exports.addToCart = async (req, res) => {
  try {
    ...
    await mirrorOperationToPostgres('create', { userId: req.params.userId, products: cart.products, totalPrice: cart.totalPrice }, 'carts');
...
exports.deleteItemFromCart = async (req, res) => {
  try {
    ...
    // Mirror operation to PostgreSQL
    await mirrorOperationToPostgres('update', { userId: req.params.userId, products: cart.products, totalPrice: cart.totalPrice }, 'carts');
...
exports.clearCart = async (req, res) => {
  try {
    ...
    // Mirror operation to PostgreSQL
    await mirrorOperationToPostgres('delete', { userId: userId }, 'carts/clear');
